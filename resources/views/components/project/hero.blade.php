<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-5 pt-30  mb-10" id="hero">
    ...
    <div class="flex flex-col gap-6 text-center lg:max-w-5xl max-w-4xl">
        <h1 class="text-center capitalize mainText gcp-headline font-medium text-foreground text-5xl lg:text-6xl leading-tight"">
            Des structures qui définissent les <span class="text-gcp-primary-color">standards</span>
        </h1>
        
        <p class="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto leading-relaxed project-desc">
            Explorez notre portfolio de projets résidentiels et commerciaux, mettant en avant la qualité, la précision et l'impact durable.
        </p>
    </div>
