...
class SubmissionResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Soumissions & Revues';

    protected static ?string $pluralModelLabel = 'Soumissions & Revues';

    protected static ?string $modelLabel = 'Soumission & Revue';

    protected static string|BackedEnum|null $navigationIcon = Heroicon::DocumentCheck;

    protected static ?string $recordTitleAttribute = 'Soumission et revues';
